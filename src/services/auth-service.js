...
export const update = (user) =>
  api
    .put(`${BASE_URL}/api/users/${user._id}`, user)
...
export const findUserById = (uid) =>
  api.get(`${BASE_URL}/api/users/${uid}`).then((response) => response.data);

export const findUserBySingleName = (username) =>
  api
    .get(`${BASE_URL}/api/users/username/single/${username}`)
    .then((response) => response.data);
